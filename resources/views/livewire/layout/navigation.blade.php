            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" wire:navigate>
                        <x-application-logo class="block h-8 w-auto text-amber-600" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @unless (auth()->user()->hasRole(\App\Enums\UserRole::Admin->value))
                        <x-nav-link :href="route('catalog.index')" :active="request()->routeIs('catalog.index')" wire:navigate>
                            {{ __('Shop') }}
                        </x-nav-link>
                        ...
                        <x-nav-link :href="route('addresses.index')" :active="request()->routeIs('addresses.index')" wire:navigate>
                            {{ __('Addresses') }}
                        </x-nav-link>
                    @endunless
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @unless (auth()->user()->hasRole(\App\Enums\UserRole::Admin->value))
                ...
                <x-responsive-nav-link :href="route('addresses.index')" :active="request()->routeIs('addresses.index')" wire:navigate>
                    {{ __('Addresses') }}
                </x-responsive-nav-link>
            @endunless
        </div>
